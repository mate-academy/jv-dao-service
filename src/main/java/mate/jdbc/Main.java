...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        driverBob.setName("Mr Bob");
        driverBob.setLicenseNumber("094349");
        Driver mrBob = driverService.update(driverBob);
        System.out.println("You update this item: " + mrBob);
        System.out.println();
        System.out.println("-------------------------------------------");
        System.out.println();

        driverService.delete(mrBob.getId());
        System.out.println("You delete this item: " + mrBob);
        System.out.println();
        System.out.println("-------------------------------------------");
        System.out.println();

        System.out.println("All DB without " + mrBob);
        driverService.getAll().forEach(System.out::println);
        System.out.println();
        System.out.println("-------------------------------------------");
        System.out.println();
