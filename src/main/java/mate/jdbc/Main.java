...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Manufacturer manufacturerHyundai = manufacturerService.create(
                new Manufacturer("Hyundai", "South Korea"));
        System.out.println(manufacturerService.get(manufacturerHyundai.getId()));
        Driver savedDriverBob = driverService.create(
                new Driver("Bob", "AB12345"));
