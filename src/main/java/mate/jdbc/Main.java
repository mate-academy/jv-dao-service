...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bob.setName("Bob");
        bob.setLicenseNumber("AB12345");
        DriverService driverService = (DriverService) injector.getInstance(DriverService.class);
        Driver driverWithId = driverService.create(bob);
        driverWithId.setName("Jack");
        driverWithId.setLicenseNumber("BC45678");
        driverService.update(driverWithId);
        Driver driverFromDb = driverService.get(driverWithId.getId());
        ...
        Manufacturer manufacturerWithId = manufacturerService.create(bmw);
        manufacturerWithId.setName("Fiat");
        manufacturerWithId.setCountry("Italy");
        manufacturerService.update(manufacturerWithId);
        Manufacturer manufacturerFromDb = manufacturerService.get(manufacturerWithId.getId());
